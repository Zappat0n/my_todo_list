...
let formProject = designer(controller).createForm(leftSide, 'form_new_project', 'form', fieldsForNewProjectForm, controller.addProject);
formProject.classList.add('d-none');
button.addEventListener('click', e => formProject.classList.toggle('d-none'));
...
let formTodo = designer().createForm(centerSide, 'form_new_todo', 'form', fieldsForNewTodoForm, controller.addTodo);
formTodo.classList.add('d-none');
button.addEventListener('click', e => formTodo.classList.toggle('d-none'));
